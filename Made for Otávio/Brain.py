    ...
    try:
        ...
        while True:
                    try:
                        ...
                        # Criar a mensagem
                        prediction_message = f"Previsão: {future_predictions[0]:.2f} | Hora: {time.strftime('%Y-%m-%d %H:%M:%S')} | Cotação Atual: {latest_price:.2f}"
