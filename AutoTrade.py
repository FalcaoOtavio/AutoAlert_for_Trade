...
def on_message(ws, message):
    ...
    if is_candle_closed:
        ...
        if last_SRSIk < 10:  # Sobrevendido (original: < 20)
            send_alert("Atenção! O ativo está sobrevendido. Possível oportunidade de compra.")
        elif last_SRSIk > 90:  # Sobrecomprado (original: > 80)
...
klines = client.get_historical_klines(trade_symbol1, Client.KLINE_INTERVAL_5MINUTE, "1 day ago UTC")
